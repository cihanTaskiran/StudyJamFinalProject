...
public class Mercury {
    ...
    public static String Description = "Merkür (Utarit), Güneş Sistemi'nin Güneş'e en yakın gezegenidir. 8 gezegenin en küçüğüdür. " +
            ...
            "krater yoğunluğunun çok düşük olduğu, yumuşak engebeli geniş düzlükler yer alır. Bu bölgeler kraterlerin sık olduğu " +
            "bölgelere göre daha alçakta yer alırlar ve Ay'daki 'deniz'lere benzer şekilde, büyük çarpmalar sonucunda gezegen " +
            "içinden yüzeye çıkan lav akıntıları ile oluştukları sanılır.";
