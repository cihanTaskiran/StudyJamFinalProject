...
public class Jupiter {
    ...
    public static String Description = "Jüpiter (Erendiz, Müşteri) Güneş Sistemi'nin en büyük gezegeni. Güneş'ten uzaklığa göre beşinci sırada " +
            ...
            "olan gezegen, böylece yüzeyine düşen Güneş ışığının yarıdan fazlasını görünür tarafta yansıtmaktadır. Ancak kızılötesi " +
            "alandaki ışınım ölçüldüğünde, Jüpiter'in Güneş'ten aldığı enerjinin 2,3 katı kadarını dışarı yaydığı görülür. Bu " +
            ...
            "yıldızlardakine yakın oranlarda içerdiği düşünülür. 20. yüzyıl başlarından itibaren, gezegenlerin çap, kütle, yoğunluk, " +
            "kendi etrafında dönme hızları, uydularının davranışları gibi verilerden yola çıkılarak iç yapıları hakkında ortaya " +
            "atılan görüşler, daha sonra tayfölçümsel çalışmalarla ve son otuz yıl içinde gerçekleştirilen birçok uzay aracı " +
            "araştırması ile zenginleştirilmiş ve günümüzde oldukça tatminkar modeller geliştirilmiştir.";
